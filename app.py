...
# Auto-load sample dataset if state is empty
...
with c1:
    st.markdown("""
        <div class="feature-box">
            ...
            <div class="feature-title">Data Overview & Cleaning</div>
            <div class="feature-desc">Automated missing value imputation, duplicate removal, type detection, and quality health profiling.</div>
        </div>
    """, unsafe_allow_html=True)
...
with c3:
    st.markdown("""
        <div class="feature-box">
            ...
            <div class="feature-desc">Time-series forecasting models to project future sales revenue with confidence interval bands.</div>
        </div>
    """, unsafe_allow_html=True)
...
with c5:
    st.markdown("""
        <div class="feature-box">
            ...
            <div class="feature-desc">Generate and download PDF executive reports, formatted Excel workbooks, and Markdown summaries.</div>
        </div>
    """, unsafe_allow_html=True)
